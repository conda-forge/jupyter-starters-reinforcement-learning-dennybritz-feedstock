About jupyter-starters-reinforcement-learning-dennybritz-feedstock
==================================================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyter-starters-reinforcement-learning-dennybritz-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12590&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyter-starters-reinforcement-learning-dennybritz-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyter-starters-reinforcement-learning-dennybritz` can be installed with `conda`:
...
```
mamba install jupyter-starters-reinforcement-learning-dennybritz
```

It is possible to list all of the versions of `jupyter-starters-reinforcement-learning-dennybritz` available on your platform with `conda`:
...
```
mamba search jupyter-starters-reinforcement-learning-dennybritz --channel conda-forge
```
...
mamba repoquery search jupyter-starters-reinforcement-learning-dennybritz --channel conda-forge

# List packages depending on `jupyter-starters-reinforcement-learning-dennybritz`:
mamba repoquery whoneeds jupyter-starters-reinforcement-learning-dennybritz --channel conda-forge

# List dependencies of `jupyter-starters-reinforcement-learning-dennybritz`:
mamba repoquery depends jupyter-starters-reinforcement-learning-dennybritz --channel conda-forge
```
